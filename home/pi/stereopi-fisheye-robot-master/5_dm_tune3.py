...
SWS = 7
PFS = 7
PFC = 63        #default = 29 ; PreFilterCap increased
MDS = -3
NOD = 128       #default = 48 ; Number of disparities increased 
TTH = 5         #default = 13 ; Texture Threshold decreased
UR = 15         #default = 3 ; Uniqueness Ratio increased          
SR = 14         #default = 14 ; Speckle Range decreased
SPWS = 50        #default = 2
...
def stereo_depth_map(rectified_pair):
    ...
    sbm = cv2.StereoBM_create(numDisparities=NOD, blockSize=21)
    ...
    #disparity_visual = (disparity-local_min)*(1.0/(local_max-local_min)) #default
